export const dict = {
  ...
  "onramp.error.bridge_timeout":
    "USDC purchase succeeded but the bridge to Soma hasn't credited yet. Check your balance shortly — it should arrive within a few minutes.",
  "sidebar.help": "Help",
