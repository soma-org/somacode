export const dict = {
  ...
  "dialog.provider.somacode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.somacode.tagline": "Reliable optimized models",
  "dialog.provider.somacodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Soma Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Soma Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.somacodeZen.line1":
    "Soma Code Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.somacodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.somacodeZen.visit.prefix": "Visit ",
  "provider.connect.somacodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.somacodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Soma Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Soma Code.",
  ...
  "dialog.plugins.empty": "Plugins configured in somacode.json",
  ...
  "dialog.server.description": "Switch which Soma Code server this app connects to.",
  ...
  "toast.update.description": "A new version of Soma Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Soma Code team",
  ...
  "error.chain.checkConfig": "Check your config (somacode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Soma Code does not support MCP authentication yet.',
  ...
  "onramp.wallet.placeholder": "0x...",
  "onramp.wallet.description": "USDC will be delivered to this Base network address.",
  "onramp.wallet.required": "Enter your wallet address to continue.",
  "onramp.wallet.invalid": "Wallet address must start with 0x and be 42 characters.",
  "onramp.start": "Continue to payment",
  "onramp.cancel": "Cancel",
  "onramp.openCheckout": "Reopen payment window",
  "onramp.openCheckoutHint": "A payment page has opened in your browser. Complete the purchase to receive USDC.",
  "onramp.waitingWarning": "Please don't close this dialog until the payment has succeeded.",
  ...
  "onramp.status.fulfillment_complete": "Purchase complete",
  ...
  "onramp.success.networkLabel": "Network",
  "onramp.success.walletLabel": "Wallet",
  "onramp.success.done": "Done",
  "onramp.rejected.heading": "Payment did not complete",
  "onramp.rejected.body":
    "Your purchase was rejected. No funds have been transferred. You can try again or use a different payment method.",
  "onramp.rejected.retry": "Try again",
  "onramp.rejected.close": "Close",
  "onramp.retry": "Try again",
  "onramp.step.wallet": "Setup Wallet",
  "onramp.step.verification": "Verification",
  "onramp.step.buyBaseUsdc": "Buy Base USDC",
  "onramp.step.toSomaUsdc": "To Soma USDC",
  "onramp.detail.loading": "Loading wallet...",
  "onramp.detail.authenticating": "Signing nonce...",
  "onramp.detail.initialized": "Continue checkout in your browser...",
  "onramp.detail.requires_payment": "Purchasing via Stripe Onramp or LiFi widget...",
  "onramp.detail.fulfillment_processing": "Processing your USDC...",
  "onramp.detail.bridge_starting": "Starting bridge to Soma...",
  "onramp.detail.bridging": "Bridging Base USDC → Soma USDC via paymaster...",
  "onramp.detail.rejected": "Payment was declined",
  "onramp.error.missing_paymaster_url": "VITE_BASE_PAYMASTER_URL is not configured.",
  "onramp.error.bridge_missing_amount": "Bridge amount is missing.",
  "onramp.error.bridge_invalid_amount": "Bridge amount must be greater than zero.",
  "onramp.error.bridge_failed": "Bridge transaction reverted on Base.",
  "onramp.error.paymaster_rejected": "Paymaster rejected the sponsorship request.",
  "onramp.error.bridge_network": "Network error while submitting the bridge transaction.",
  "onramp.error.bridge_unsupported": "Bridge is not supported on this platform.",
  "sidebar.help": "Help",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "Soma Code includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Soma Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Soma Code",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Soma Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Soma Code.",
