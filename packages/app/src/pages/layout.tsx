...
import { base64Encode } from "@somacode-ai/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@somacode-ai/ui/resize-handle"
import { Button } from "@somacode-ai/ui/button"
import { IconButton } from "@somacode-ai/ui/icon-button"
import { Tooltip } from "@somacode-ai/ui/tooltip"
import { DropdownMenu } from "@somacode-ai/ui/dropdown-menu"
import { Dialog } from "@somacode-ai/ui/dialog"
import { getFilename } from "@somacode-ai/core/util/path"
import { Session, type Message } from "@somacode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@somacode-ai/ui/toast"
...
import { Binary } from "@somacode-ai/core/util/binary"
import { retry } from "@somacode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@somacode-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://somacode.ai/desktop-feedback")}
      renderPanel={() =>
